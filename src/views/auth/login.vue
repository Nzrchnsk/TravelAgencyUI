<template>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form>
                <input type="email" required v-model="data.email" id="login" class="fadeIn second" name="login" placeholder="E-mail">
                ...
                <input type="button" @click="login" class="fadeIn fourth" value="Войти">
            </form>
